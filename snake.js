$(document).on('ready', function() {
	//Crear un contexto 2d del canvas.
	var canvas = $("#snake")[0];
	var context = canvas.getContext("2d");

	//Obtenemos el ancho y alto de nuestro canvas (del html).
	...
	var deaths = 0;
	var meters;
	var level = 20; //1 El nivel más lento, 10 el nivel más rápido.
	...
	{		
		...
		var infoGame = "Pasos: "+ meters+" | Puntaje: " + score + " | Muertes: "+ deaths;
		
		context.fillText(infoGame, 5, height - 5);
